...
class TimingResult:
    ...
    arts_startup_sec: Optional[float] = None
    omp_startup_sec: Optional[float] = None
    arts_verification_sec: Optional[float] = None
    omp_verification_sec: Optional[float] = None
    arts_cleanup_sec: Optional[float] = None
    omp_cleanup_sec: Optional[float] = None
